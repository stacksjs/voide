#!/usr/bin/env bun
/**
 * Build CSS with Crosswind
 */
// @ts-ignore - crosswind package.json exports are misconfigured
import { build, defaultConfig } from '../node_modules/@stacksjs/crosswind/dist/index.js'
...
try {
  ...
  // Build CSS using Crosswind API
  const result = await build(config)

  // Additional utilities that Crosswind doesn't generate automatically
...
/* Placeholder colors (not auto-generated by crosswind) */
